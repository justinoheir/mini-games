...
const GAME_PATH = '/games/spiral-throw'           // ← CHANGE THIS
const GAME_ID   = 'spiral-throw'                  // ← CHANGE THIS (matches localStorage key)
const ACCENT    = '#a16207'                    // ← CHANGE THIS (game accent color)
