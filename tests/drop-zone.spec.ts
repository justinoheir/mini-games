...
const GAME_ID = 'drop-zone'; const GAME_PATH = '/games/drop-zone'; const ACCENT = '#22d3ee'; const GAME_DURATION_MS = 45000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('drop-zone haptics: '+log.length);
})