...
const GAME_ID = 'pixel-paint'; const GAME_PATH = '/games/pixel-paint'; const ACCENT = '#f472b6'; const GAME_DURATION_MS = 30000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('pixel-paint haptics: '+log.length);
})