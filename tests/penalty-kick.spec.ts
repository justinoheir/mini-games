...
const GAME_PATH = '/games/penalty-kick'           // ← CHANGE THIS
const GAME_ID   = 'penalty-kick'                  // ← CHANGE THIS (matches localStorage key)
const ACCENT    = '#22c55e'                    // ← CHANGE THIS (game accent color)
