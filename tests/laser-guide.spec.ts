...
const GAME_ID = 'laser-guide'; const GAME_PATH = '/games/laser-guide'; const ACCENT = '#dc2626'; const GAME_DURATION_MS = 45000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('laser-guide haptics: '+log.length);
})