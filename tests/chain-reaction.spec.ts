...
const GAME_ID = 'chain-reaction'; const GAME_PATH = '/games/chain-reaction'; const ACCENT = '#fb7185'; const GAME_DURATION_MS = 30000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('chain-reaction haptics: '+log.length);
})