...
const GAME_PATH = '/games/reflex-rally'           // ← CHANGE THIS
const GAME_ID   = 'reflex-rally'                  // ← CHANGE THIS (matches localStorage key)
const ACCENT    = '#84cc16'                    // ← CHANGE THIS (game accent color)
