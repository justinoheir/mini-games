...
const GAME_ID = 'gravity-well'; const GAME_PATH = '/games/gravity-well'; const ACCENT = '#7c3aed'; const GAME_DURATION_MS = 60000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('gravity-well haptics: '+log.length);
})