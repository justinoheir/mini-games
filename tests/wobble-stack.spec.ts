...
const GAME_ID = 'wobble-stack'; const GAME_PATH = '/games/wobble-stack'; const ACCENT = '#fb923c'; const GAME_DURATION_MS = 60000;
...
test('12.1 — haptics fire', async ({ page }) => {
  ...
  const log = await game.getVibrateLog(); console.log('wobble-stack haptics: '+log.length);
})