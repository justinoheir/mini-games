...
// TODO: migrate to Supabase once glimmer_qa_results table is created.
// SQL to run in Supabase dashboard:
// CREATE TABLE glimmer_qa_results (id uuid DEFAULT gen_random_uuid() PRIMARY KEY,
//   game_id text NOT NULL UNIQUE, game_name text, game_emoji text, accent_color text,
//   sensor text, duration_seconds integer, qa_date text, qa_agent text,
//   verdict text NOT NULL DEFAULT 'NOT_RUN', weighted_score numeric,
//   dimensions jsonb, performance jsonb, accessibility jsonb, personas jsonb,
//   bugs jsonb, iterations_required integer DEFAULT 0, deploy_url text,
//   created_at timestamptz DEFAULT now(), updated_at timestamptz DEFAULT now());
// ALTER TABLE glimmer_qa_results ENABLE ROW LEVEL SECURITY;
