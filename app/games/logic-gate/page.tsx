...
const GAME_ID='logic-gate';const ACCENT='#64748b';const DURATION=60;const GAME_EMOJI='⚙️';const GAME_TITLE='Logic Gate';const GAME_TAGLINE='Wire the circuit. Get the output.';
...
export default function LogicGate(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Logic Gate game canvas'}/>
