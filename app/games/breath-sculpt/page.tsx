...
const GAME_ID='breath-sculpt';const ACCENT='#34d399';const DURATION=60;const GAME_EMOJI='💨';const GAME_TITLE='Breath Sculpt';const GAME_TAGLINE='Breathe to shape. Slow or fast.';
...
export default function BreathSculpt(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#001a0a';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Breath Sculpt game canvas'}/>
