...
const GAME_ID='sound-garden';const ACCENT='#4ade80';const DURATION=60;const GAME_EMOJI='🌿';const GAME_TITLE='Sound Garden';const GAME_TAGLINE='Touch to grow. Grow to play.';
...
const COLS=['#4ade80','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function SoundGarden(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#001a04';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Sound Garden game canvas'}/>
