...
const GAME_ID='neon-chess';const ACCENT='#00ffff';const DURATION=60;const GAME_EMOJI='♟️';const GAME_TITLE='Neon Chess';const GAME_TAGLINE='One move. Best move. Neon style.';
...
export default function NeonChess(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Neon Chess game canvas'}/>
