...
const GAME_ID='bead-catch';const ACCENT='#a855f7';const DURATION=30;const GAME_EMOJI='📿';const GAME_TITLE='Bead Catch';const GAME_TAGLINE='Tilt to catch the beads!';
...
const COLS=['#a855f7','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function BeadCatch(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#0f0018';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Bead Catch game canvas'}/>
