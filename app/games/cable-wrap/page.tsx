...
const GAME_ID='cable-wrap';const ACCENT='#34d399';const DURATION=45;const GAME_EMOJI='🔌';const GAME_TITLE='Cable Wrap';const GAME_TAGLINE='No tangles. No mercy.';
...
export default function CableWrap(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#001a10';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Cable Wrap game canvas'}/>
