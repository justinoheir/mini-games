...
const GAME_ID='inference-trail';const ACCENT='#7c3aed';const DURATION=60;const GAME_EMOJI='🕵️';const GAME_TITLE='Inference Trail';const GAME_TAGLINE='Follow the clues. Find the answer.';
...
export default function InferenceTrail(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      // Background: #0f080a
      ctx.fillStyle='#0f080a';ctx.fillRect(0,0,W,H);
      // Accent grid overlay
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Inference Trail game canvas'}/>
