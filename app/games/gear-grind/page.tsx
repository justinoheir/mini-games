...
const GAME_ID='gear-grind';const ACCENT='#94a3b8';const DURATION=60;const GAME_EMOJI='⚙️';const GAME_TITLE='Gear Grind';const GAME_TAGLINE='Mesh the gears. Keep it spinning.';
...
export default function GearGrind(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Gear Grind game canvas'}/>
