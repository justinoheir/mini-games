...
const GAME_ID='basket-weave';const ACCENT='#d97706';const DURATION=60;const GAME_EMOJI='🧺';const GAME_TITLE='Basket Weave';const GAME_TAGLINE='Over. Under. Don\x27t drop a strand.';
...
const COLS=['#d97706','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function BasketWeave(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Basket Weave game canvas'}/>
