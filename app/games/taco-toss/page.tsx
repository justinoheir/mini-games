...
const GAME_ID='taco-toss';const ACCENT='#84cc16';const DURATION=45;const GAME_EMOJI='🌮';const GAME_TITLE='Taco Toss';const GAME_TAGLINE='Catch the fillings. Build the taco.';
...
const COLS=['#84cc16','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function TacoToss(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Taco Toss game canvas'}/>
