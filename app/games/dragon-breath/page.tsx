...
const GAME_ID='dragon-breath';const ACCENT='#ef4444';const DURATION=30;const GAME_EMOJI='🐉';const GAME_TITLE='Dragon Breath';const GAME_TAGLINE='Blow hard. Breathe fire!';
...
export default function DragonBreath(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Dragon Breath game canvas'}/>
