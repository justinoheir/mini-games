...
const GAME_ID='dreidel-spin';const ACCENT='#3b82f6';const DURATION=30;const GAME_EMOJI='🔵';const GAME_TITLE='Dreidel Spin';const GAME_TAGLINE='Flick it hard. Watch it spin!';
...
export default function DreidelSpin(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Dreidel Spin game canvas'}/>
