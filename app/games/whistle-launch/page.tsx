...
const GAME_ID='whistle-launch';const ACCENT='#fbbf24';const DURATION=45;const GAME_EMOJI='🚀';const GAME_TITLE='Whistle Launch';const GAME_TAGLINE='Whistle to launch. Pitch to steer.';
...
export default function WhistleLaunch(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Whistle Launch game canvas'}/>
