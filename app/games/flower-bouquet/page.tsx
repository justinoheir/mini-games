...
const GAME_ID='flower-bouquet';const ACCENT='#f472b6';const DURATION=45;const GAME_EMOJI='💐';const GAME_TITLE='Flower Bouquet';const GAME_TAGLINE='Catch the petals. Build love.';
...
export default function FlowerBouquet(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#150010';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Flower Bouquet game canvas'}/>
