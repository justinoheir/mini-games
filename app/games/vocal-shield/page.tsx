...
const GAME_ID='vocal-shield';const ACCENT='#818cf8';const DURATION=30;const GAME_EMOJI='🛡️';const GAME_TITLE='Vocal Shield';const GAME_TAGLINE='Sing it. Block it. Hold it.';
...
export default function VocalShield(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Vocal Shield game canvas'}/>
