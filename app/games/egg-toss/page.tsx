...
const GAME_ID='egg-toss';const ACCENT='#fde68a';const DURATION=45;const GAME_EMOJI='🥚';const GAME_TITLE='Egg Toss';const GAME_TAGLINE='Toss it. Catch it. Don\x27t crack it!';
...
export default function EggToss(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#1a1800';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Egg Toss game canvas'}/>
