...
const GAME_ID='dragon-parade';const ACCENT='#ef4444';const DURATION=60;const GAME_EMOJI='🐲';const GAME_TITLE='Dragon Parade';const GAME_TAGLINE='Multi-touch the dragon. Make it dance!';
...
const COLS=['#ef4444','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function DragonParade(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Dragon Parade game canvas'}/>
