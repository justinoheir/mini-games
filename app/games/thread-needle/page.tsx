...
const GAME_ID='thread-needle';const ACCENT='#e879f9';const DURATION=30;const GAME_EMOJI='🪡';const GAME_TITLE='Thread Needle';const GAME_TAGLINE='Steady hands only. Pros need not apply.';
...
export default function ThreadNeedle(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#12001a';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Thread Needle game canvas'}/>
