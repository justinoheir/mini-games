...
const GAME_ID='mirror-mind';const ACCENT='#8b5cf6';const DURATION=45;const GAME_EMOJI='🪞';const GAME_TITLE='Mirror Mind';const GAME_TAGLINE='Both hands. Mirrored. Synchronized.';
...
export default function MirrorMind(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Mirror Mind game canvas'}/>
