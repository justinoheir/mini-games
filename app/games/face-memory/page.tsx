...
const GAME_ID='face-memory';const ACCENT='#f43f5e';const DURATION=60;const GAME_EMOJI='👤';const GAME_TITLE='Face Memory';const GAME_TAGLINE='Remember the faces. Spot them.';
...
export default function FaceMemory(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      // Background: #150008
      ctx.fillStyle='#150008';ctx.fillRect(0,0,W,H);
      // Accent grid overlay
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Face Memory game canvas'}/>
