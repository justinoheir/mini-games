...
const GAME_ID='lantern-float';const ACCENT='#f97316';const DURATION=45;const GAME_EMOJI='🏮';const GAME_TITLE='Lantern Float';const GAME_TAGLINE='Blow them up. Watch them rise.';
...
const COLS=['#f97316','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function LanternFloat(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Lantern Float game canvas'}/>
