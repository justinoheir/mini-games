...
const GAME_ID='beat-box';const ACCENT='#f97316';const DURATION=60;const GAME_EMOJI='🎵';const GAME_TITLE='Beat Box';const GAME_TAGLINE='Drop the beat. Keep it going.';
...
export default function BeatBox(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#150500';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Beat Box game canvas'}/>
