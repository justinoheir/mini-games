...
const GAME_ID='echo-match';const ACCENT='#06b6d4';const DURATION=45;const GAME_EMOJI='🔊';const GAME_TITLE='Echo Match';const GAME_TAGLINE='Match the echo. Hold the note.';
...
export default function EchoMatch(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Echo Match game canvas'}/>
