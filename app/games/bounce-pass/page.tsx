...
const GAME_ID='bounce-pass';const ACCENT='#84cc16';const DURATION=45;const GAME_EMOJI='⛹️';const GAME_TITLE='Bounce Pass';const GAME_TAGLINE='Angle the bounce. Make the pass.';
...
export default function BouncePass(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#070f00';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Bounce Pass game canvas'}/>
