...
const GAME_ID='tower-stack';const ACCENT='#f59e0b';const DURATION=60;const GAME_EMOJI='🏗️';const GAME_TITLE='Tower Stack';const GAME_TAGLINE='Drop it. Stack it. Don\x27t tip it.';
...
export default function TowerStack(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#130800';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Tower Stack game canvas'}/>
