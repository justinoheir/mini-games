...
const GAME_ID='spatial-map';const ACCENT='#0ea5e9';const DURATION=60;const GAME_EMOJI='🗺️';const GAME_TITLE='Spatial Map';const GAME_TAGLINE='Study the map. Answer fast.';
...
export default function SpatialMap(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Spatial Map game canvas'}/>
