...
const GAME_ID='surf-ride';const ACCENT='#06b6d4';const DURATION=60;const GAME_EMOJI='🏄';const GAME_TITLE='Surf Ride';const GAME_TAGLINE='Tilt to balance. Swipe for tricks.';
...
export default function SurfRide(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#001518';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Surf Ride game canvas'}/>
