...
const GAME_ID='sing-along';const ACCENT='#fb7185';const DURATION=45;const GAME_EMOJI='🎵';const GAME_TITLE='Sing Along';const GAME_TAGLINE='Match the note. Hold it perfect.';
...
export default function SingAlong(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#180008';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Sing Along game canvas'}/>
