...
const GAME_ID='chant-power';const ACCENT='#dc2626';const DURATION=45;const GAME_EMOJI='📢';const GAME_TITLE='Chant Power';const GAME_TAGLINE='Hold the chant. Charge the power.';
...
export default function ChantPower(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Chant Power game canvas'}/>
