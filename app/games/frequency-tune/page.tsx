...
const GAME_ID='frequency-tune';const ACCENT='#f472b6';const DURATION=45;const GAME_EMOJI='🎛️';const GAME_TITLE='Frequency Tune';const GAME_TAGLINE='Find the frequency. Hold it.';
...
export default function FrequencyTune(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#14000f';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Frequency Tune game canvas'}/>
