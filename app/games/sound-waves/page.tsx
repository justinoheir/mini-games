...
const GAME_ID='sound-waves';const ACCENT='#22d3ee';const DURATION=45;const GAME_EMOJI='🌊';const GAME_TITLE='Sound Waves';const GAME_TAGLINE='Shout the frequency. Shatter walls.';
...
export default function SoundWaves(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Sound Waves game canvas'}/>
