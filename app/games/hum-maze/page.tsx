...
const GAME_ID='hum-maze';const ACCENT='#14b8a6';const DURATION=60;const GAME_EMOJI='🎶';const GAME_TITLE='Hum Maze';const GAME_TAGLINE='Change your pitch. Navigate.';
...
export default function HumMaze(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#001512';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Hum Maze game canvas'}/>
