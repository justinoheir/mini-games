...
const GAME_ID='bbq-master';const ACCENT='#f97316';const DURATION=60;const GAME_EMOJI='🍔';const GAME_TITLE='BBQ Master';const GAME_TAGLINE='Flip it right. Don't burn dad's burger.';
...
export default function BbqMaster(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'BBQ Master game canvas'}/>
