...
const GAME_ID='magnet-maze';const ACCENT='#ef4444';const DURATION=60;const GAME_EMOJI='🧲';const GAME_TITLE='Magnet Maze';const GAME_TAGLINE='Attract, repel, navigate.';
...
export default function MagnetMaze(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#1a0004';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Magnet Maze game canvas'}/>
