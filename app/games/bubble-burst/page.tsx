...
const GAME_ID='bubble-burst';const ACCENT='#67e8f9';const DURATION=30;const GAME_EMOJI='🫧';const GAME_TITLE='Bubble Burst';const GAME_TAGLINE='Pinch at the perfect size!';
...
export default function BubbleBurst(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Bubble Burst game canvas'}/>
