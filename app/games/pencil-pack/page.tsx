...
const GAME_ID='pencil-pack';const ACCENT='#3b82f6';const DURATION=30;const GAME_EMOJI='✏️';const GAME_TITLE='Pencil Pack';const GAME_TAGLINE='Sort and pack. School starts now.';
...
const COLS=['#3b82f6','#4ade80','#3b82f6','#f43f5e','#fbbf24','#a855f7','#f97316','#06b6d4'];
export default function PencilPack(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Pencil Pack game canvas'}/>
