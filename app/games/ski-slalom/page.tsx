...
const GAME_ID='ski-slalom';const ACCENT='#818cf8';const DURATION=45;const GAME_EMOJI='⛷️';const GAME_TITLE='Ski Slalom';const GAME_TAGLINE='Weave through the gates. Go fast.';
...
export default function SkiSlalom(){
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Ski Slalom game canvas'}/>
