...
const GAME_ID='pinata-smash';const ACCENT='#ec4899';const DURATION=30;const GAME_EMOJI='🎉';const GAME_TITLE='Piñata Smash';const GAME_TAGLINE='Find the weak spot. Smash!';
...
export default function PinataSmash(){
  ...
  const startLoop=useCallback(()=>{
    ...
    const loop=()=>{
      ...
      ctx.fillStyle='#14001a';ctx.fillRect(0,0,W,H);
  ...
  return(<GameShell title={GAME_TITLE} emoji={GAME_EMOJI} accentColor={theme.colors.accent??ACCENT}>
    ...
    {(phase==='playing'||phase==='countdown')&&(<><canvas ref={canvasRef} style={{position:'absolute',inset:0,width:'100%',height:'100%',touchAction:'none'}} role="img" aria-label={'Piñata Smash game canvas'}/>
